...
document.getElementById('subir-txt').addEventListener('change', function() {
    const archivo = this.files[0];
    const texto = archivo ? `Archivo cargado: ${archivo.name}` : 'Ningún archivo seleccionado';
    document.getElementById('archivo-cargado').textContent = texto;
});


document.getElementById('boton-reiniciar').addEventListener('click', function() {
    // Limpiar los campos
    document.getElementById('subir-txt').value = '';
    document.getElementById('frecuencias').textContent = '';
    document.getElementById('codigos').textContent = '';
    document.getElementById('comprimido').textContent = '';
    document.getElementById('archivo-cargado').textContent = 'Ningún archivo seleccionado';
});
